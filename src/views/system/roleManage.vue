...
import { getAllMenus, assignMenusToRole, type Menu } from '../../api/menu'
import { getAllPermissions, assignPermissionsToRole, type Permission } from '../../api/permission'
...
const handleMenuSubmit = async () => {
  ...
  const success = await assignMenusToRole(currentRole.value.id!, checkedKeys)
