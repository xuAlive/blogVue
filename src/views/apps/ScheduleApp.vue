      ...
      <div class="header-content">
        ...
        <div class="header-right">
          <el-radio-group v-model="activeTab" size="default">
            ...
            <el-radio-button label="employee">员工管理</el-radio-button>
            <el-radio-button label="statistics">统计报表</el-radio-button>
          </el-radio-group>
        </div>
      </div>
    </el-card>
    ...
    <template v-if="activeTab === 'schedule'">
      ...
      <el-card class="date-card">
        <div class="date-selector">
          ...
          <el-button type="primary" @click="showCreateDialog" icon="Plus" style="margin-left: 20px;">添加排班</el-button>
        </div>
      </el-card>
            ...
            <tbody>
              <tr v-for="employee in displayEmployees" :key="employee.employeeCode">
                ...
                <td v-for="day in weekDays" :key="day.date"
                  ...
                  <div class="shift-cell" @click.stop="editSchedule(getSchedule(employee.employeeCode, day.date))">
...
const displayEmployees = computed(() => {
  return allEmployees.value.filter(e => e.status === 1)
})
